  ...
  return (
    <div className="relative w-full">
      ...
      <label htmlFor="file-input" className="block">
        <div className="w-full min-w-[315px] h-[56px] px-4 rounded-lg flex items-center justify-between font-semibold text-lg ring-2 ring-inset ring-gray-300 cursor-pointer">
