    ...
    <div className='min-w-[375px] scroll-smooth'>
      {!isEstimateRequested ? (
        <>
          ...
          <div className="hidden sl:flex al:flex mx:flex justify-center overflow-auto min-w-[809px] h-screen font-sans bg-black bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "bg-[url('/backgroundLg.svg')]" }}>
            <FeatureListLarge />
          </div>
        </>
      ) : (
