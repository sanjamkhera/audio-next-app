...
const Home = () => {
  ...
  return (
    <div className='min-w-[315px]'>
      {!isEstimateRequested ? (
        <>
          <div className="flex justify-center overflow-auto h-screen font-sans">
            <Hero {...commonProps} />
          </div>
          ...
          <div className="hidden sl:flex al:flex mx:flex justify-center overflow-auto min-w-[809px] h-screen font-sans bg-black bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/backgroundLg.svg')" }}>
            <FeatureListLarge />
          </div>
        </>
      ) : (
